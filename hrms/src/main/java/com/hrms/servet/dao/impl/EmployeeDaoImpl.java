...
public class EmployeeDaoImpl implements EmployeeDao {
	...
	private static final String GET_ALL_EMPLOYEE_QUERY = "SELECT employee.employee_id, employee.name, employee.category_of_employment, employee.designation, employee.department, employee.reporting_to, employee.date_of_joining, employee.month, employee.years_of_completion, employee.approx_years_completion, employee.probation_period, employee.date_of_confirmation, employee.location, employee.date_of_birth, employee.age_till_date, employee.date_of_month, employee.appointment_letter, employee.nda, employee.confirmation_or_probation, employee.id_card, employee.account, employee.bank_account, employee.ifsc_code, employee.uan_number, employee.pf_number, employee.marital_status, employee.gender, employee.official_contact_no, employee.personal_contact_no, employee.alternate_contact_no, employee.personal_email_id, employee.official_email_id, employee.blood_group, employee.current_address, employee.permanent_address, employee.highest_qualification, employee.total_experience, employee.relevant_experience, employee.previous_company, employee.designation_in_previous_company, employee.experience_with_ppt, employee.date_of_resignation, employee.retirement_date, employee.exit_date, employee.education_certificate, employee.ration_card, employee.pan_card, employee.aadhar_card, employee.driving_license, employee.passport, employee.bank_name, employee.name_as_per_bank, employee.account_number, employee.ifsc_code_bank, role.role_code, role.role_name, role.role_level FROM employee LEFT JOIN role ON role.role_code = employee.designation";
	...
	private static final String GET_EMPLOYEE_DETAILS_BY_ID_QUERY = "SELECT employee.employee_id, employee.name, employee.category_of_employment, employee.designation, employee.department, employee.reporting_to, employee.date_of_joining, employee.month, employee.years_of_completion, employee.approx_years_completion, employee.probation_period, employee.date_of_confirmation, employee.location, employee.date_of_birth, employee.age_till_date, employee.date_of_month, employee.appointment_letter, employee.nda, employee.confirmation_or_probation, employee.id_card, employee.account, employee.bank_account, employee.ifsc_code, employee.uan_number, employee.pf_number, employee.marital_status, employee.gender, employee.official_contact_no, employee.personal_contact_no, employee.alternate_contact_no, employee.personal_email_id, employee.official_email_id, employee.blood_group, employee.current_address, employee.permanent_address, employee.highest_qualification, employee.total_experience, employee.relevant_experience, employee.previous_company, employee.designation_in_previous_company, employee.experience_with_ppt, employee.date_of_resignation, employee.retirement_date, employee.exit_date, employee.education_certificate, employee.ration_card, employee.pan_card, employee.aadhar_card, employee.driving_license, employee.passport, employee.bank_name, employee.name_as_per_bank, employee.account_number, employee.ifsc_code_bank, role.role_code, role.role_name, role.role_level FROM employee LEFT JOIN role ON role.role_code = employee.designation where employee.employee_id = ? ";
